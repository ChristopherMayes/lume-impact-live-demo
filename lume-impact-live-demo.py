...
DISTGEN_LASER_FILE = os.environ.get('distgen_laser_file')
if not DISTGEN_LASER_FILE:
    raise ValueError("distgen_laser_file not defined in toml.")

# Number of processors
NUM_PROCS = os.environ.get('num_procs')
if not NUM_PROCS:
...
MPI_RUN_CMD = os.environ.get("mpi_run_cmd")
if not MPI_RUN_CMD:
